...
if not os.path.exists('Rostros encontrados2'):
	print('Carpeta creada: Rostros encontrados2')
...
while True:
	...
	faces = faceClassif.detectMultiScale(gray, 1.3, 3)
	...
	for (x,y,w,h) in faces:
		...
		cv2.imwrite('Rostros encontrados2/rostro_{}.jpg'.format(count),rostro)
